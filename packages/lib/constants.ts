...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://sasstudio.ma";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "SAS Studio";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@sasstudio.ma";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "SAS Studio";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "SAS Studio";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "SAS Studio";
